...
describe("Factory Extended Tests", function () {
  ...
  describe("Initial Purchase Limits", function () {
    it("should reject excessive initial purchases", async function () {
      ...
      await assetToken
        .connect(alice)
        .approve(await factory.getAddress(), ethers.parseEther(`${100_000}`)); // Large amount
      ...
      await expect(factory
        ...
        .launch(
          ...
          "https://test.com",
          "Test intention",
          ethers.parseEther(`${100_000}`), // Trying to purchase more than 5% of supply
          dexConfig,
          defaultAirdropParams
